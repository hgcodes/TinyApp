...
function checkUrl(req, res, next) {
  if (urlDatabase[req.params.id]) {
    ...
    res.status(404).send("Page does not exist. <a href='/urls'>Return to TinyApp.</a>");
  }
}
...
function authenticate(req, res, next){
  if (req.session.user_id) {
    ...
    res.status(401).send("<h1>TinyApp</h1><br>Please <a href='/login'>login</a> or <a href='/register'>register</a> to view this page.");
  }
}
